...
?>
    ...
    <body>
        <form class="idea_login_form" id="idea_form_login">
            ...
            <span class="idea_login_span_title">LEARNIDEA</span>
            <input type="text" name="usuario_email" placeholder="USUARIO" class="idea_login_input_text">
