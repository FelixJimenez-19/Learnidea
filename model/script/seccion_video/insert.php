...
if (isset($_POST['seccion_video_nombre']) and isset($_POST['seccion_video_iframe']) and isset($_POST['seccion_video_descripcion']) and isset($_POST['curso_seccion_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($seccion_video_nombre, $seccion_video_iframe, $seccion_video_descripcion, $curso_seccion_id);
