...
if (isset($_POST['transaccion_tipo_nombre']) and isset($_POST['transaccion_tipo_descripcion']) and isset($_POST['transaccion_tipo_credido']) and isset($_POST['transaccion_tipo_pago']) and isset($_POST['transaccion_tipo_entrada']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($transaccion_tipo_nombre, $transaccion_tipo_descripcion, $transaccion_tipo_credido, $transaccion_tipo_pago, $transaccion_tipo_entrada);
        ...
        if (isset($_FILES['transaccion_tipo_logo'])) {
            ...
            if ($transaccion_tipo_logo['tmp_name'] != "" or $transaccion_tipo_logo['tmp_name'] != null) {
                ...
                $transaccion_tipo_id = mysqli_fetch_assoc($_entity->selectByAll($transaccion_tipo_nombre, $transaccion_tipo_descripcion, $transaccion_tipo_credido, $transaccion_tipo_pago, $transaccion_tipo_entrada))['transaccion_tipo_id'];
