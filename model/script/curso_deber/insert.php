...
- RUTA: proyect/model/script/curso_deber/insert.php
*/
...
if (isset($_POST['curso_deber_descripcion']) and isset($_POST['curso_deber_link']) and isset($_POST['curso_deber_fecha_inicio']) and isset($_POST['curso_deber_fecha_fin']) and isset($_POST['curso_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($curso_deber_descripcion, $curso_deber_link, $curso_deber_fecha_inicio, $curso_deber_fecha_fin, $curso_id);
        ...
        if (isset($_FILES['curso_deber_foto'])) {
            ...
            if ($curso_deber_foto['tmp_name'] != "" or $curso_deber_foto['tmp_name'] != null) {
                ...
                $curso_deber_id = mysqli_fetch_assoc($_entity->selectByAll($curso_deber_descripcion, $curso_deber_link, $curso_deber_fecha_inicio, $curso_deber_fecha_fin, $curso_id))['curso_deber_id'];
