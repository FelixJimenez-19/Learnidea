...
- RUTA: proyect/model/script/video_comentario/insert.php
*/
...
if (isset($_POST['video_comentario_descripcion']) and isset($_POST['video_comentario_fecha']) and isset($_POST['seccion_video_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($video_comentario_descripcion, $video_comentario_fecha, $seccion_video_id);
        ...
        if (isset($_FILES['video_comentario_foto'])) {
            ...
            if ($video_comentario_foto['tmp_name'] != "" or $video_comentario_foto['tmp_name'] != null) {
                ...
                $video_comentario_id = mysqli_fetch_assoc($_entity->selectByAll($video_comentario_descripcion, $video_comentario_fecha, $seccion_video_id))['video_comentario_id'];
