...
- RUTA: proyect/model/script/deber_entrega/insert.php
*/
...
if (isset($_POST['deber_entrega_descripcion']) and isset($_POST['deber_entrega_link']) and isset($_POST['deber_entrega_fecha_inicio']) and isset($_POST['deber_entrega_fecha_fin']) and isset($_POST['curso_deber_id']) and isset($_POST['inscripcion_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($deber_entrega_descripcion, $deber_entrega_link, $deber_entrega_fecha_inicio, $deber_entrega_fecha_fin, $curso_deber_id, $inscripcion_id);
        ...
        if (isset($_FILES['deber_entrega_foto'])) {
            ...
            if ($deber_entrega_foto['tmp_name'] != "" or $deber_entrega_foto['tmp_name'] != null) {
                ...
                $deber_entrega_id = mysqli_fetch_assoc($_entity->selectByAll($deber_entrega_descripcion, $deber_entrega_link, $deber_entrega_fecha_inicio, $deber_entrega_fecha_fin, $curso_deber_id, $inscripcion_id))['deber_entrega_id'];
