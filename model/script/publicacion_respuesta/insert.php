...
- RUTA: proyect/model/script/publicacion_respuesta/insert.php
*/
...
if (isset($_POST['publicacion_respuesta_descripcion']) and isset($_POST['publicacion_respuesta_fecha']) and isset($_POST['publicacion_comentario_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($publicacion_respuesta_descripcion, $publicacion_respuesta_fecha, $publicacion_comentario_id);
        ...
        if (isset($_FILES['publicacion_respuesta_foto'])) {
            ...
            if ($publicacion_respuesta_foto['tmp_name'] != "" or $publicacion_respuesta_foto['tmp_name'] != null) {
                ...
                $publicacion_respuesta_id = mysqli_fetch_assoc($_entity->selectByAll($publicacion_respuesta_descripcion, $publicacion_respuesta_fecha, $publicacion_comentario_id))['publicacion_respuesta_id'];
