...
if (isset($_POST['institucion_nombre']) and isset($_POST['institucion_siglas']) and  isset($_POST['institucion_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->update($institucion_nombre, $institucion_siglas, $institucion_id);
