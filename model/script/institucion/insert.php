...
if (isset($_POST['institucion_nombre']) and isset($_POST['institucion_siglas']) and isset($_POST['institucion_link']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($institucion_nombre, $institucion_siglas, $institucion_link);
        if (isset($_FILES['institucion_logo'])) {
            ...
            if ($institucion_logo['tmp_name'] != "" or $institucion_logo['tmp_name'] != null) {
                ...
                $institucion_id = mysqli_fetch_assoc($_entity->selectByAll($institucion_nombre, $institucion_siglas, $institucion_link))['institucion_id'];
