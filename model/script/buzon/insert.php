...
- RUTA: proyect/model/script/buzon/insert.php
*/
...
if (isset($_POST['buzon_email']) and isset($_POST['buzon_descripcion']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        $buzon_email = $_POST['buzon_email'];
        $buzon_descripcion = $_POST['buzon_descripcion'];
        $_entity->insert($buzon_email, $buzon_descripcion);
        ...
        if (isset($_FILES['buzon_foto'])) {
            ...
            if ($buzon_foto['tmp_name'] != "" or $buzon_foto['tmp_name'] != null) {
                ...
                $buzon_id = mysqli_fetch_assoc($_entity->selectByAll($buzon_email, $buzon_descripcion))['buzon_id'];
