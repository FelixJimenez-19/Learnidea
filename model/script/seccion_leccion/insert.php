...
if (isset($_POST['seccion_leccion_descripcion']) and isset($_POST['seccion_leccion_puntaje']) and isset($_POST['seccion_leccion_intentos']) and isset($_POST['curso_seccion_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($seccion_leccion_descripcion, $seccion_leccion_puntaje, $seccion_leccion_intentos, $curso_seccion_id);
