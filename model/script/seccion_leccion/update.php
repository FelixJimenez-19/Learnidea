...
if (isset($_POST['seccion_leccion_descripcion']) and isset($_POST['seccion_leccion_puntaje']) and isset($_POST['seccion_leccion_intento']) and isset($_POST['seccion_leccion_tiempo']) and isset($_POST['curso_seccion_id']) and  isset($_POST['seccion_leccion_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->update($seccion_leccion_descripcion, $seccion_leccion_puntaje, $seccion_leccion_intento, $seccion_leccion_tiempo, $curso_seccion_id, $seccion_leccion_id);
