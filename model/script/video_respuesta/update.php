...
- RUTA: proyect/model/script/video_respuesta/update.php
*/
...
if (isset($_POST['video_respuesta_descripcion']) and isset($_POST['video_respuesta_fecha']) and isset($_POST['video_comentario_id']) and  isset($_POST['video_respuesta_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->update($video_respuesta_descripcion, $video_respuesta_fecha, $video_comentario_id, $video_respuesta_id);
