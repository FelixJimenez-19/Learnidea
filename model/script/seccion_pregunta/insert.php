...
if (isset($_POST['seccion_pregunta_descripcion']) and isset($_POST['seccion_pregunta_porcentaje']) and isset($_POST['seccion_leccion_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        ...
        $_entity->insert($seccion_pregunta_descripcion, $seccion_pregunta_porcentaje, $seccion_leccion_id);
