...
- RUTA: proyect/model/script/slider/update.php
*/
...
if (isset($_POST['slider_frase']) and isset($_POST['slider_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        $slider_frase = $_POST['slider_frase'];
        $slider_id = $_POST['slider_id'];
        $_entity->update($slider_frase, $slider_id);
