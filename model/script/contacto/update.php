...
if (isset($_POST['contacto_nombre']) and isset($_POST['contacto_url']) and  isset($_POST['contacto_id']) and isset($_POST['key'])) {
    if (validation($_POST['key'])) {
        $contacto_nombre = $_POST['contacto_nombre'];
        $contacto_url = $_POST['contacto_url'];
        $contacto_id = $_POST['contacto_id'];
        $_entity->update($contacto_nombre, $contacto_url, $contacto_id);
