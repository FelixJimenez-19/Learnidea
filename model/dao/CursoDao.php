...
class CursoDao
{
    ...
    public function insert($curso_nombre, $curso_fecha_inicio, $curso_fecha_fin, $curso_cupos, $curso_whatsapp, $curso_calificacion, $curso_proximo, $curso_visible, $curso_precio_live, $curso_precio_record, $curso_certificado_live, $curso_certificado_record, $curso_certificacion_live, $curso_modelo_id)
    {
        return $this->conn->query("INSERT INTO curso SET curso_nombre='$curso_nombre', curso_fecha_inicio='$curso_fecha_inicio', curso_fecha_fin='$curso_fecha_fin', curso_cupos=$curso_cupos, curso_whatsapp='$curso_whatsapp', curso_calificacion=$curso_calificacion, curso_proximo=$curso_proximo, curso_visible=$curso_visible, curso_precio_live=$curso_precio_live, curso_precio_record=$curso_precio_record, curso_certificado_live=$curso_certificado_live, curso_certificado_record=$curso_certificado_record, curso_certificacion_live=$curso_certificacion_live, curso_modelo_id=$curso_modelo_id ");
    }
    public function update($curso_nombre, $curso_fecha_inicio, $curso_fecha_fin, $curso_cupos, $curso_whatsapp, $curso_calificacion, $curso_proximo, $curso_visible, $curso_precio_live, $curso_precio_record, $curso_certificado_live, $curso_certificado_record, $curso_certificacion_live, $curso_modelo_id, $curso_id)
    {
        return $this->conn->query("UPDATE curso SET curso_nombre='$curso_nombre', curso_fecha_inicio='$curso_fecha_inicio', curso_fecha_fin='$curso_fecha_fin', curso_cupos=$curso_cupos, curso_whatsapp='$curso_whatsapp', curso_calificacion=$curso_calificacion, curso_proximo=$curso_proximo, curso_visible=$curso_visible, curso_precio_live=$curso_precio_live, curso_precio_record=$curso_precio_record, curso_certificado_live=$curso_certificado_live, curso_certificado_record=$curso_certificado_record, curso_certificacion_live=$curso_certificacion_live, curso_modelo_id=$curso_modelo_id WHERE curso_id = $curso_id ");
    }
    ...
    public function selectByAll($curso_nombre, $curso_fecha_inicio, $curso_fecha_fin, $curso_cupos, $curso_whatsapp, $curso_calificacion, $curso_proximo, $curso_visible, $curso_precio_live, $curso_precio_record, $curso_certificado_live, $curso_certificado_record, $curso_certificacion_live, $curso_modelo_id)
    {
