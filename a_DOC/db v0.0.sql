-- ELIMINAR COMENTARIOS INNECESARIOS A LA HORA DE EJECUTARLO EN SPEEDSOFT

DROP DATABASE learnidea;
...
CREATE TABLE seccion_leccion (
    ...
    seccion_leccion_puntaje VARCHAR(5),
    curso_seccion_id INT,
    FOREIGN KEY (curso_seccion_id) REFERENCES curso_seccion (curso_seccion_id)
) ENGINE INNODB;

CREATE TABLE leccion_pregunta (
    leccion_pregunta_id INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
    leccion_pregunta_descripcion TEXT,
...
CREATE TABLE pregunta_alternativa (
    pregunta_alternativa_id INT PRIMARY KEY AUTO_INCREMENT NOT NULL,
    pregunta_alternativa_descripcion TEXT,
    pregunta_alternativa_correta BOOLEAN,
    leccion_pregunta_id INT,
    FOREIGN KEY (leccion_pregunta_id) REFERENCES leccion_pregunta (leccion_pregunta_id)
) ENGINE INNODB;
