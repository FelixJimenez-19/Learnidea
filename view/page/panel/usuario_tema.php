                ...
                <div class="inputs">
                    ...
                    <div class="row">
                        ...
                        <div class="input-radio-container">
                            <input type="radio" name="usuario_tema_default" class="input-radio-si-no" value="1" placeholder="SI">
                            <input type="radio" name="usuario_tema_default" class="input-radio-si-no" value="0" placeholder="NO">
                        </div>
                    </div>
...
<?php
        ...
        header("location: ../../../panel?page=usuario_tema");
    }
} else {
