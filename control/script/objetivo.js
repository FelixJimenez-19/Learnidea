            ...
            return `
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="entity.fun.showModalConfirm('¿Esta seguro de eliminar este registro?', () => entity.objetivo.index = ${index})">
    ...
    objetivo: {
        ...
        crud: {
            select: async () => {
                ...
                await ObjetivoDao.selectByCurso_modelo_id(formData)
                    .then((res) => {
