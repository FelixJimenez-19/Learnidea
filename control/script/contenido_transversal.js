...
<button><img src="view/src/icon/delete.png" onclick="entity.fun.showModalConfirm('¿Esta seguro de eliminar este registro?', () => entity.contenido_transversal.index = ${index}); "></button>
</td>
</tr>
`;
        },
    ...
    contenido_transversal: {
        ...
        crud: {
            select: async () => {
                await Contenido_transversalDao.select()
                    .then((res) => {
