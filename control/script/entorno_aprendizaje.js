...
<button><img src="view/src/icon/delete.png" onclick="entity.fun.showModalConfirm('¿Esta seguro de eliminar este registro?', () => entity.entorno_aprendizaje.index = ${index}); "></button>
</td>
</tr>
`;
        },
    ...
    entorno_aprendizaje: {
        ...
        crud: {
            select: async () => {
                await Entorno_aprendizajeDao.select()
                    .then((res) => {
