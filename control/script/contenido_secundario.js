            ...
            return `
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="entity.fun.showModalConfirm('¿Esta seguro de eliminar este registro?', () => entity.contenido_secundario.index = ${index})">
    ...
    contenido_secundario: {
        ...
        crud: {
            select: async () => {
                ...
                await Contenido_secundarioDao.selectByCurso_modelo_id(formData)
                    .then((res) => {
