...
<button><img src="view/src/icon/delete.png" onclick="entity.fun.showModalConfirm('¿Esta seguro de eliminar este registro?', () => entity.participante_tipo.index = ${index}); "></button>
</td>
</tr>
`;
        },
