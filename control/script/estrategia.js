            ...
            return `
                <tr>
                    ...
                    <td>
                        ...
                        <button onclick="entity.fun.showModalConfirm('¿Esta seguro de eliminar este registro?', () => entity.estrategia.index = ${index})">
    ...
    estrategia: {
        ...
        crud: {
            select: async () => {
                ...
                await EstrategiaDao.selectByCurso_modelo_id(formData)
                    .then((res) => {
